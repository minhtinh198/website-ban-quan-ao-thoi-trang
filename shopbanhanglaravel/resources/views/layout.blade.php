                        ...
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                <?php
                                   ...
                                   if($customer_id!=NULL){ 
                                 ?>
                                  <li><a href="{{URL::to('/logout-checkout')}}"><i class="fa fa-lock"></i> Đăng ký</a></li>
                                
                                <?php
                            }else{
                                 ?>
                                 <li><a href="{{URL::to('/dang-nhap')}}"><i class="fa fa-lock"></i> Đăng ký</a></li>
                                 <?php 
                             }
                                 ?>
                    ...
                    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                        ...
                        @foreach($slider as $key => $slide)
                            ...
                            <div class="item {{$i==1 ? 'active' : '' }}">
                                ...
                                <div class="col-sm-12">
                                    <img alt="{{$slide->slider_desc}}" src="{{asset('public/uploads/slider/'.$slide->slider_image)}}" height="320px" width="100%" >
                ...
                <div class="row">
                    <div class="col-sm-2">
                        <div class="single-widget">
                            <h2>Họ Và Tên</h2>
                            <ul class="nav nav-pills nav-stacked">
                                <li><a href="#">Phạm Minh Tính</a></li>
                                <li><a href="#">Phan Quang Thông</a></li>
