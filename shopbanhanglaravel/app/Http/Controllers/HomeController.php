...
class HomeController extends Controller
{
    public function send_mail(){
         //send mail
                $to_name = "Tinh Pham";
                $to_email = "phamminhtinh1998@gmail.com";//send to this email
    ...
    public function search(Request $request){
        ...
        //$search_product = DB::table('tbl_product')->where('product_name',$keywords)->get(); theo tên

        //$search_product = DB::table('tbl_product')->where('product_name',$keywords)->orwhere('product_price',$keywords)->get(); theo ten hoặc theo giá
